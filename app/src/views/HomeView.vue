  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
      <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8 border border-gray-100">
        ...
        <div v-if="hasProgress" class="space-y-6">
          <!-- Main stats grid -->
        ...
        <div v-else class="text-center py-6">
          ...
          <p class="text-gray-600 mb-6 max-w-md mx-auto">
            Begin your German grammar journey! Start with tables to learn the patterns, then practice with flashcards.
          </p>
          <div class="flex flex-col sm:flex-row gap-3 justify-center">
            <router-link
              to="/tables"
              class="px-6 py-2.5 bg-violet-600 text-white rounded-lg font-semibold hover:bg-violet-700 transition-colors"
            >
              Explore Tables
            </router-link>
            <router-link
